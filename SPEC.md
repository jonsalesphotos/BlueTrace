...
> **状态（2026-07-06 口径修正）**：本节 v0.1 "12B 自研信封"方案**整体待重构思，已归档**（`Docs/归档/自研协议线_v0/`）——M7 采集协议改为**在现网 B2A 协议主体上添加/扩展**（B2A/zqdata 真源：`Docs/归档/s7/S7协议共识规格.md`），UWTP（`Docs/UWTP/`）仅作思考方向、可能借用部分设计。新方案成稿前，本节保留为帧层设计素材。
