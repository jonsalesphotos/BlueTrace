...
>
> **2026-07-06 更新**：M7 冻结路径二选一——本规格所属**自研线**（v0.1 + [BTCP/1 演进稿](03_collect_protocol_design.md)）vs [UWTP V0.99](../UWTP/UWTP_BLE_Protocol_Design_V0.99.md)（当前冻结候选基线）；评审拍板前本稿为自研线帧层权威。
>
