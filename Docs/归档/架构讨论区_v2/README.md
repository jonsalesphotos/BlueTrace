...
| [02_parser_registry_design.md](../../architecture/02_parser_registry_design.md) | **可注册通道解析器架构**（ProtocolProfile / ChannelParser / Registry，S7 接入示例） | ✅ 设计稿 |
| [03_collect_protocol_design.md](../../architecture/03_collect_protocol_design.md) | **采集链路协议 BTCP/1**（在线流式 + 离线回传，TLV+protobuf+分包） | ✅ 设计稿 |
